...
module "yugabyte_clusters_project1_monitor" {
  for_each   = var.yugabyte_clusters_project1_monitor
  project_id = var.project_id
  source     = "./modules/yugabyte_db_engine"
...
module "yugabyte_clusters_project1_config" {
  for_each   = var.yugabyte_clusters_project1_config
  project_id = var.project_id
  source     = "./modules/yugabyte_db_engine"
